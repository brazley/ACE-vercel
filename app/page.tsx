    ...
    <Layout>
      <div className="flex-1 space-y-4">
        <div className="flex items-center justify-between space-y-2">
          <h2 className="text-3xl font-bold tracking-tight fade-in">Dashboard</h2>
        </div>
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 slide-in">
          <Card>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 slide-in">
